        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Data Privacy & Protection <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Solutions</span>
            </motion.h2>
            <motion.p
            ...
            >
              Comprehensive data privacy management and AI governance solutions built for enterprise compliance
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              transition={{ delay: 0.2 }}
            >
              Industry-leading AI-powered data privacy platform trusted by 500+ enterprises worldwide
            </motion.p>
          </div>
            ...
            {[
              {
                ...
                description: "94.5% accuracy with custom ML models for sensitive data classification",
                metric: "94.5%"
              },
              {
                iconPath: "M13 10V3L4 14h7v7l9-11h-7z",
                title: "High-Performance Processing",
                description: "Process 10M+ records per hour with HPC-powered data accelerator",
                metric: "10M+"
              },
              {
                iconPath: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
                title: "Data Sovereignty & Privacy",
                description: "On-premises, cloud, or hybrid deployment - your data stays secure",
                metric: "100%"
              },
              {
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <motion.p
                ...
                transition={{ delay: 0.2 }}
              >
                Everything you need for enterprise data privacy, AI governance, and regulatory compliance
              </motion.p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                {
                  title: "Data Discovery & Classification",
                  description: "Automatically discover, classify, and tag sensitive data including PII, PHI, and financial information across all data sources.",
                  link: "/product-offering",
                  linkText: "Learn about data discovery"
                },
                {
                  title: "Consent & Preference Management",
                  description: "Manage user consent, preferences, and opt-outs with automated cookie consent banners and preference centers.",
                  link: "/storefront",
                  linkText: "Explore consent management"
                },
                {
                  title: "Data Subject Rights (DSAR)",
                  description: "Automate data subject access requests, right to erasure, and data portability with built-in workflows.",
                  link: "/faqs",
                  linkText: "DSAR automation FAQ"
                },
                {
                  title: "Privacy Impact Assessments",
                  description: "Conduct and document DPIAs with guided templates and automated risk scoring for new projects.",
                  link: "/blog",
                  linkText: "Read privacy guides"
                },
                {
                  title: "Data Breach Management",
                  description: "72-hour breach notification workflows, incident tracking, and automated regulatory reporting.",
                  link: "/contact-us",
                  linkText: "Get breach response plan"
                },
                {
                  title: "Vendor Risk Management",
                  description: "Assess third-party vendors, track data processing agreements, and monitor compliance continuously.",
                  link: "/about",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              How Our Data Privacy Platform <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Works</span>
            </motion.h2>
            <motion.p
              className="text-lg text-muted-foreground max-w-2xl mx-auto"
              initial={{ opacity: 0 }}
              ...
              transition={{ delay: 0.2 }}
            >
              Automated data privacy compliance in three simple steps - deploy, detect, and protect
            </motion.p>
          </div>
            ...
            {[
              {
                ...
                description: "Quick deployment in your environment - on-premises, cloud, or hybrid. Implementation in 48 hours with zero data sharing.",
                icon: "🚀"
              },
              {
                step: "02",
                title: "Discover & Classify Data",
                description: "AI-powered data discovery automatically identifies and classifies PII, PHI, and sensitive data across all systems with 94.5% accuracy.",
                icon: "🔍"
              },
              {
                step: "03",
                title: "Automate Compliance",
                description: "Automated data protection, policy enforcement, and compliance reporting for GDPR, CCPA, HIPAA with real-time monitoring.",
                icon: "🛡️"
              }
            ].map((step, i) => (
              <motion.div
      ...
      <section className="py-20 bg-gradient-cta">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p
            ...
            transition={{ delay: 0.2 }}
          >
            Join 500+ enterprises that trust DataSafeguard for AI-powered data privacy management, 
            automated compliance, and enterprise-grade protection.
          </motion.p>
          <motion.div
